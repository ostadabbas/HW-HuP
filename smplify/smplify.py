...
class SMPLify():
    ...
    def __init__(self, 
        ...
        # add wt for pose and shape to ignore the pose prior
        # Store options
        self.device = device
    ...
    def __call__(self, init_pose, init_betas, init_cam_t, camera_center, keypoints_2d):
        ...
        body_pose = init_pose[:, 3:].detach().clone()       # detach to optimize
        ...
        for i in range(self.num_iters):
            smpl_output = self.smpl(global_orient=global_orient,
                                    body_pose=body_pose,
                                    betas=betas)        # the regressor is loaded in, specific for SPIN model.
        ...
        for i in range(self.num_iters):
            ...
            loss = body_fitting_loss(body_pose, betas, model_joints, camera_translation, camera_center,
                                     ...
                                     pose_prior_weight=self.wt_pose,
                                     shape_prior_weight=self.wt_shp)
