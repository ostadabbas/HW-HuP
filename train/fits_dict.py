...
class FitsDict():
    ...
    def __init__(self, options, train_dataset):
        ...
        for ds_name, ds in train_dataset.dataset_dict.items():      # h36m_fits is not available
            try:
                ...
                self.fits_dict[ds_name] = torch.from_numpy(np.load(dict_file))  # {'h36m': dict_file}
    ...
    def __setitem__(self, x, val):
        """ Update dictionary entries , update ds ith parameters"""
        # rotate back the pose,
